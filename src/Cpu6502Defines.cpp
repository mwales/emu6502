...
void constructCpuGlobals()
{
   ...
   CPU_OP(0x19, 3, ORA, ora, ABS_ZP_Y   , 4, false, FLG_NONE)
   CPU_OP(0x1a, 1, NOP, nop, IMPLIED    , 2, false, FLG_ZERO | FLG_NEG )
   CPU_OP(0x1b, 3, SLO, slo, ABS_ZP_Y   , 7, false, FLG_NONE)
   CPU_OP(0x1c, 3, NOP, nop, ABS_ZP_X   , 4, false, FLG_ZERO)
   CPU_OP(0x1d, 3, ORA, ora, ABS_ZP_X   , 4, false, FLG_NONE)
   CPU_OP(0x1e, 3, ASL, asl, ABS_ZP_X   , 7, true,  FLG_ZERO | FLG_NEG )
   CPU_OP(0x1f, 3, SLO, slo, ABS_ZP_X   , 7, false, FLG_NONE)
   ...
   CPU_OP(0x39, 3, AND, and, ABS_ZP_Y   , 4, false, FLG_NONE)
   CPU_OP(0x3a, 1, NOP, nop, IMPLIED    , 2, false, FLG_ZERO | FLG_NEG )
   CPU_OP(0x3b, 3, RLA, rla, ABS_ZP_Y   , 7, false, FLG_NONE)
   CPU_OP(0x3c, 3, NOP, nop, ABS_ZP_X   , 4, true,  FLG_OVFL | FLG_ZERO | FLG_NEG )
   CPU_OP(0x3d, 3, AND, and, ABS_ZP_X   , 4, false, FLG_NONE)
   CPU_OP(0x3e, 3, ROL, rol, ABS_ZP_X   , 7, true,  FLG_ZERO | FLG_NEG )
   CPU_OP(0x3f, 3, RLA, rla, ABS_ZP_X   , 7, false, FLG_NONE)
   ...
   CPU_OP(0x59, 3, EOR, eor, ABS_ZP_Y   , 4, false, FLG_NONE)
   CPU_OP(0x5a, 1, NOP, nop, IMPLIED    , 2, false, FLG_NONE)
   CPU_OP(0x5b, 3, SRE, sre, ABS_ZP_Y   , 7, false, FLG_NONE)
   CPU_OP(0x5c, 3, NOP, nop, ABS_ZP_X   , 4, false, FLG_NONE)
   CPU_OP(0x5d, 3, EOR, eor, ABS_ZP_X   , 4, false, FLG_NONE)
   CPU_OP(0x5e, 3, LSR, lsr, ABS_ZP_X   , 7, true,  FLG_ZERO | FLG_NEG )
   CPU_OP(0x5f, 3, SRE, sre, ABS_ZP_X   , 7, false, FLG_NONE)
   ...
   CPU_OP(0x79, 3, ADC, adc, ABS_ZP_Y   , 4, false, FLG_CARY | FLG_OVFL | FLG_ZERO | FLG_NEG )
   CPU_OP(0x7a, 1, NOP, nop, IMPLIED    , 2, false, FLG_ZERO | FLG_NEG )
   CPU_OP(0x7b, 3, RRA, rra, ABS_ZP_Y   , 7, false, FLG_NONE)
   CPU_OP(0x7c, 3, NOP, nop, ABS_ZP_X   , 4, false, FLG_NONE)
   CPU_OP(0x7d, 3, ADC, adc, ABS_ZP_X   , 4, false, FLG_CARY | FLG_OVFL | FLG_ZERO | FLG_NEG )
   CPU_OP(0x7e, 3, ROR, ror, ABS_ZP_X   , 7, true,  FLG_ZERO | FLG_NEG )
   CPU_OP(0x7f, 3, RRA, rra, ABS_ZP_X   , 7, false, FLG_NONE)
   ...
   CPU_OP(0x99, 3, STA, sta, ABS_ZP_Y   , 5, false, FLG_NONE)
   CPU_OP(0x9a, 1, TXS, txs, IMPLIED    , 2, false, FLG_NONE)
   CPU_OP(0x9b, 3, TAS, tas, ABS_ZP_Y   , 5, false, FLG_NONE)
   CPU_OP(0x9c, 3, SHY, shy, ABS_ZP_X   , 5, false, FLG_NONE)
   CPU_OP(0x9d, 3, STA, sta, ABS_ZP_X   , 5, false, FLG_NONE)
   CPU_OP(0x9e, 3, SHX, shx, ABS_ZP_Y   , 5, false, FLG_NONE)
   CPU_OP(0x9f, 3, AHX, ahx, ABS_ZP_Y   , 5, false, FLG_NONE)
   ...
   CPU_OP(0xb9, 3, LDA, lda, ABS_ZP_Y   , 4, false, FLG_NONE)
   CPU_OP(0xba, 1, TSX, tsx, IMPLIED    , 2, false, FLG_NONE)
   CPU_OP(0xbb, 3, LAS, las, ABS_ZP_Y   , 4, false, FLG_NONE)
   CPU_OP(0xbc, 3, LDY, ldy, ABS_ZP_X   , 4, false, FLG_NONE)
   CPU_OP(0xbd, 3, LDA, lda, ABS_ZP_X   , 4, false, FLG_NONE)
   CPU_OP(0xbe, 3, LDX, ldx, ABS_ZP_Y   , 4, false, FLG_NONE)
   CPU_OP(0xbf, 3, LAX, lax, ABS_ZP_Y   , 4, false, FLG_NONE)
   ...
   CPU_OP(0xd9, 3, CMP, cmp, ABS_ZP_Y   , 4, false, FLG_NONE)
   CPU_OP(0xda, 1, NOP, nop, IMPLIED    , 2, false, FLG_NONE)
   CPU_OP(0xdb, 3, DCP, dcp, ABS_ZP_Y   , 7, false, FLG_NONE)
   CPU_OP(0xdc, 3, NOP, nop, ABS_ZP_X   , 4, false, FLG_NONE)
   CPU_OP(0xdd, 3, CMP, cmp, ABS_ZP_X   , 4, false, FLG_NONE)
   CPU_OP(0xde, 3, DEC, dec, ABS_ZP_X   , 7, false, FLG_NONE)
   CPU_OP(0xdf, 3, DCP, dcp, ABS_ZP_X   , 7, false, FLG_NONE)
   ...
   CPU_OP(0xf9, 3, SBC, sbc, ABS_ZP_Y   , 4, false, FLG_CARY | FLG_OVFL | FLG_ZERO | FLG_NEG )
   CPU_OP(0xfa, 1, NOP, nop, IMPLIED    , 2, false, FLG_ZERO | FLG_NEG )
   CPU_OP(0xfb, 3, ISC, isc, ABS_ZP_Y   , 7, false, FLG_NONE)
   CPU_OP(0xfc, 3, NOP, nop, ABS_ZP_X   , 4, false, FLG_NONE)
   CPU_OP(0xfd, 3, SBC, sbc, ABS_ZP_X   , 4, false, FLG_CARY | FLG_OVFL | FLG_ZERO | FLG_NEG )
   CPU_OP(0xfe, 3, INC, inc, ABS_ZP_X   , 7, false, FLG_NONE)
   CPU_OP(0xff, 3, ISC, isc, ABS_ZP_X   , 7, false, FLG_NONE)
